...
<section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
    <div class="flex flex-col gap-2 text-center">
        <h6 class="text-large sm:text-xl md:text-2xl">No need of waiting! Click to confirm your space</h6>
        <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl">
            Your parking slot is ready
        </h3>
        <div class="flex justify-center mt-16">
            <div class="w-full lg:max-w-lg">
                <form on:submit|preventDefault   class="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 flex flex-col items-center">
                    ...
                    <div class="flex flex-col gap-4 items-center">
                        ...
                        <div class="flex flex-row gap-4">
                            <label class="label flex flex-col items-start">
                                ...
                                <input bind:value={date} class="input border-black rounded-md mt-1 text-black" type="date" />
                            </label>
                            ...
                            <label class="label flex flex-col items-start">
                                ...
                                <input bind:value={endTime} class="input border-black rounded-md mt-1 text-black" type="time" />
                            </label>
                        </div>
